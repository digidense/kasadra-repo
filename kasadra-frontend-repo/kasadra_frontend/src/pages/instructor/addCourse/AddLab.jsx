      ...
      <div className="add-lab-body">
        <div className="add-lab-card enhanced-ui">
          ...
          <form className="add-lab-form" onSubmit={handleSubmit}>
            ...
            {/* Success / Error */}
            {success && <p className="add-lab-success">Lab added successfully!</p>}
            {error && <p className="add-lab-error-msg">{error || "Something went wrong"}</p>}

            {/* Buttons */}
            <div className="add-lab-buttons">
              <button
                type="submit"
                className="add-lab-ok-btn"
                disabled={loading }
              >
