  ...
  return (
    <Routes>
      ...
      <Route element={<StudentProtectedRoute />}>
        ...
        <Route
          path="/student/profile/:studentId/edit"
          element={<EditProfile />}
        />
      ...
      <Route element={<InstructorProtectedRoute />}>
        ...
        <Route path="/instructor/lesson-view/:courseId/:lessonId" element={<LessonView />} />
        <Route path="/instructor/:courseId/:lessonId/lesson-content" element={<LessonContent />} />
        <Route path="/instructor/:courseId/:lessonId/addpdf" element={<AddPDF />} />
        <Route path="/instructor/:courseId/:lessonId/addweblink" element={<AddWeblink />} />
        <Route path="/instructor/:courseId/:lessonId/notepad" element={<NotePad />} />
        ...
        <Route
          ...
          element={<AddConcept />}
        />
        <Route path="/instructor/:courseId/:lessonId/addlab" element={<AddLab />} />
        <Route path="/instructor/:courseId/:lessonId/addquiz" element={<AddQuiz />} />
        ...
        />
        <Route path="/instructor/assign-batch/select" element={<SelectBatch />} />
